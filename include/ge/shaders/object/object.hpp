...
namespace ge {
    inline GLuint initShaderObject(void)
    {
        std::string vertexSource = ge::loadShaderSource("include/ge/shaders/object/vertex.glsl");
        const char *vertexShaderSrc = vertexSource.c_str();

        std::string fragmentSource = ge::loadShaderSource("include/ge/shaders/object/fragment.glsl");
